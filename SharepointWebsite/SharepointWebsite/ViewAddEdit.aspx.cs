    ...
    public partial class ViewAddEdit : System.Web.UI.Page
    {
        ...
        public ClientContext CreateClientContext()
        {
            using (var clientContext = new ClientContext("https://acuvatehyd.sharepoint.com/teams/SharePointDemo"))
            {
                ...
                string passwd = "Nagu_10011994";
                SecureString password = GetPassword(passwd);
        ...
        {
            isCtx = CreateClientContext();
            if (isCtx != null)
            {
                List l = isCtx.Web.Lists.GetByTitle("Employees");
                isCtx.Load(l);
                isCtx.ExecuteQuery();
        ...
        protected void SubmitButton_Click(object sender, EventArgs e)
        {
            try
            {
                List list = isCtx.Web.Lists.GetByTitle("Employees");
