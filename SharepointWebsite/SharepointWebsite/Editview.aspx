<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editview.aspx.cs" Inherits="SharepointWebsite.Editview" %>
        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:Button type="submit" ID="SubmitButton" style="margin-left: 3%;" CssClass="btn btn-success" runat="server" Font-Bold="True" OnClick="SubmitButton_Click" Text="Update" ToolTip="click to add view" />
